...
% Add custom meeting title
\newcommand{\meetingtitle}[1]{\begin{textblock*}{0.9\paperwidth}
(0.05\paperwidth,0.2\paperheight){\begin{center}#1\end{center}}\end{textblock*}}

\newcommand{\smalltitle}[1]{\begin{textblock*}{0.9\paperwidth}
(0.05\paperwidth,0.55\paperheight){\begin{center}\usebeamerfont{title}\LARGE
